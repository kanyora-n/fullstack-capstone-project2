...
function SearchPage() {
    ...
    const [ageRange, setAgeRange] = useState(6); // Initialize with a default value (e.g., 6)
    ...
    const handleSearch = async () => {
        ...
        const queryParams = new URLSearchParams({
            name: searchQuery,
            age_years: ageRange,
            category: document.getElementById('categorySelect')?.value, // Add optional chaining
            condition: document.getElementById('conditionSelect')?.value, // Add optional chaining
        }).toString();
