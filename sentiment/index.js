...
app.post('/sentiment', async (req, res) => { // POST /sentiment

    // Task 4: extract the sentence parameter
    const { sentence } = req.body; // Extract sentence from req.body
    ...
    try {
        ...
        res.status(500).json({ message: 'Error performing sentiment analysis' }); // Send 500 on error
    }
});
